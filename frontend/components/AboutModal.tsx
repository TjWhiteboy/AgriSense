...
const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
          ...
          <div
            className="bg-white dark:bg-[#161B22] rounded-2xl w-full max-w-lg shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700 animate-slide-in transition-colors duration-500 ease-in-out"
            onClick={(e) => e.stopPropagation()}
          >
              <div className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                      <LeafLogoIcon className="h-12 w-12 text-green-500" />
                      <div>
                        <h3 id="about-title" className="text-xl font-bold text-gray-900 dark:text-gray-100">
                            AgriSense
                        </h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">{TRANSLATIONS.headerSubtitle}</p>
                      </div>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      Developed by <strong>Thikash</strong>, AgriSense is a Management Information System designed to function as a powerful Decision Support System for farmers, converting complex data into simple, actionable intelligence.
                  </p>
              ...
              <div className="bg-gray-50 dark:bg-[#21262D]/50 px-6 py-3 flex justify-end transition-colors duration-500 ease-in-out">
                  <button
                      type="button"
                      onClick={onClose}
