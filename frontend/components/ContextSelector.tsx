      ...
      <div className="flex-1">
        ...
        <div className="relative">
          <select
            ...
            className="w-full p-2 text-sm bg-white dark:bg-[#161B22] border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors duration-500 ease-in-out text-gray-800 dark:text-gray-200"
          >
