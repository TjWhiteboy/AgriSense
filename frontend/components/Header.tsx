...
const Header: React.FC<HeaderProps> = ({ theme, onToggleTheme, onToggleSidebar }) => {
  return (
    <header className="flex items-center justify-between p-2 sm:p-4 bg-white dark:bg-[#161B22] border-b border-gray-200 dark:border-gray-700/80 transition-colors duration-500 ease-in-out">
      ...
      <div className="flex items-center">
        <button
          ...
          className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-500 ease-in-out"
